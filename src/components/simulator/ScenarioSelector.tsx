    ...
    <div className="flex-1 overflow-y-auto p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="mb-6"
        >
          <h2 className="text-xl font-bold text-slate-100 mb-1">ETCS Mode Simulator</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          {scenarios.map((scenario, index) => {
            ...
            return (
              <motion.button
                ...
                className="group relative text-left p-4 rounded-xl bg-slate-900/80 border border-slate-800 hover:border-slate-600 hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-200"
              >
                <div className="flex items-start justify-between mb-2">
                  <h3 className="text-sm font-semibold text-slate-100 group-hover:text-blue-300 transition-colors pr-2">
                    {scenario.title}
                  </h3>
                  <div
          ...
          <motion.button
            ...
            className="group relative text-left p-4 rounded-xl bg-gradient-to-br from-slate-900/80 to-blue-950/40 border border-blue-500/20 hover:border-blue-500/40 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-200"
          >
            <div className="flex items-start justify-between mb-2">
