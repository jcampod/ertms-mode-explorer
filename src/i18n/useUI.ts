...
const EN_DEFAULTS: UITranslations = {
  ...
  jpSpeed: 'Speed (km/h)',
  jpTime: 'Time',
  jpLayerEtcsCeiling: 'ETCS Ceiling',
  jpLayerAtoTarget: 'ATO Target',
  jpLayerPhaseColors: 'Phase Colors',
  jpLayerGradients: 'Gradients',
  ...
  jpSpeed2x: '25\u00D7',
  jpSpeed4x: '50\u00D7',
  jpSegmentProfiles: 'Segment Profiles',
  jpSegmentDetails: 'Segment Details',
  jpLineSpeed: 'Line Speed',
  jpGradient: 'Gradient',
  jpRestriction: 'Restriction',
  jpTemporary: 'Temporary',
  jpPermanent: 'Permanent',
  jpStatistics: 'Journey Statistics',
  jpTotalDistance: 'Total Distance',
  jpJourneyTime: 'Journey Time',
  jpNumberOfStops: 'Stops',
  jpEnergySaving: 'Energy Saving',
  jpUphill: 'Uphill',
  jpDownhill: 'Downhill',
  jpFlat: 'Flat',
  jpLayers: 'Layers',
